...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update_Delete_Member");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField10, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE))
                        .addGap(49, 49, 49))))
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Connection Con=ConnectionProvider.getCon();
            PreparedStatement ps=Con.prepareStatement("update member set name=?,mobilenumber=?,email=?,fathername=?,gymtime=?,cnic=?,age=?,amount=? where id=?");
            ps.setString(1,name);
